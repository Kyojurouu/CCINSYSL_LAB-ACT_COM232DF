...
def generate_raw_evidence(num_records=100):
    ...
    for event in events:
        if event == 'login':
            ...
            messages.append(f'Accessed sensitive document path: /home/{users[random.randint(0, num_records-1)]}/docs/private_file_{random.randint(1, 5)}.txt')
    ...
    # Randomly set some user_id and message fields to NaN/None
